	...
	BEGIN TRY
		...
		BEGIN TRAN
			...
			BEGIN
				...
				IF @id = 0
					RAISERROR('ƒолжен быть указан хот€ бы один св€занный параметр дл€ вычислени€ значени€!',16,9);
				...
				IF EXISTS(
					...
					RAISERROR('—в€занные параметры должны быть простого типа!',16,10);					
				...
				HAVING(COUNT(1) > 1)
					...
					RAISERROR('—в€занные параметры не должны дублироватьс€!',16,11);
