...
ALTER TABLE [dbo].[LoginResourceLimits] CHECK CONSTRAINT [FK_LoginResourceLimits_Logins]
GO
ALTER TABLE [dbo].[LoginResourceLimits] CHECK CONSTRAINT [FK_LoginResourceLimits_ResourceLimits]
GO
